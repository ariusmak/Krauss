...
st.set_page_config(page_title="Regime attempts", page_icon=":bar_chart:",
                   layout="wide")
...
st.title("Regime attempts")
st.caption(
    "Three independent regime frameworks tested; all three null. This page "
    "shows the one that is fully materialised in the app data — the VIX "
    "regime grid plus rescue-rule decomposition. The other two produced the "
    "same conclusion through different routes; their outputs are summarised "
    "in the top paragraph but not reconstructed here because they aren't "
    "part of the current data pipeline."
)
